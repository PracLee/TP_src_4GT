	...
	<div class="tm-header-wrapper">
		...
		<ul id="blogLinks">
			<li class="blog" id="BJBlog"><a rel="nofollow"
				href="https://fb.com/templatemo"><img alt="이병재 블로그"
					src="img/BJ2.png"></a></li>
			<li class="blog" id="HTBlog"><a href="https://twitter.com"><img
					alt="오현택 블로그" src="img/HT2.png"></a></li>
			<li class="blog" id="HJBlog"><a href="https://instagram.com"><img
					alt="김혁재 블로그" src="img/HJ2.png"></a></li>
			<li class="blog" id="YNBlog"><a href="https://linkedin.com"><img
					alt="이예나 블로그" src="img/YN2.png"></a></li>
			<li class="blog" id="THBlog"><a href="https://linkedin.com"><img
