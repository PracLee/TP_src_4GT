        ...
        <main class="tm-main">
            ...
            <c:forEach var="pl" items="${PostList}">
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <p class="tm-pt-30">
                        <a rel="nofollow" class="underline" href="https://templatemo.com/tm-553-xtra-blog" target="_blank">Xtra Blog</a>  is a multi-purpose HTML CSS template from TemplateMo website. 
